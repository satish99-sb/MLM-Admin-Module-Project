  ...
  <nav class="blue darken-2">
    <div class="">
      <div class="nav-wrapper">
        <a href="${pageContext.request.contextPath}/income-history" class="brand-logo">User</a>
        ...
        <ul class="right hide-on-med-and-down">
          ...
          <li>
            <a href="${pageContext.request.contextPath}/view-pin">View Pin</a>
          </li>
          <li>
            <a href="#">User's Tree</a>
          </li>
          <li>
            <a href="${pageContext.request.contextPath}/payment-receive">User Payment History</a>
          </li>
        </ul>
        <!-- Side nav -->
          ...
          <div class="card-panel blue darken-2 white-text center">
            <h3> Total Users </h3>
              <table class="responsive-table centered">
                ...
                <tbody>
                	<c:forEach var="users" items="${allUsersByTopUserID}">
                		<tr>
                			<td> ${users.id } </td>
