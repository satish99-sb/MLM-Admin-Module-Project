  ...
  <nav class="blue darken-2">
    <div class="">
      <div class="nav-wrapper">
        <a href="${pageContext.request.contextPath}/showUsersRevenue" class="brand-logo">Admin</a>
        <a href="#" data-activates="side-nav" class="button-collapse show-on-large right">
          <i class="material-icons">menu</i>
        </a>
        <ul class="right hide-on-med-and-down">
          <li class="active">
            <a href="${pageContext.request.contextPath}/showUsersRevenue">Dashboard</a>
          </li>
          <li>
        ...
        <ul id="side-nav" class="side-nav">
          ...
          <li>
            <a href="${pageContext.request.contextPath}/showUsersRevenue">
